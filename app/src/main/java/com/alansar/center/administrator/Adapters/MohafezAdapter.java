...
public class MohafezAdapter extends RecyclerView.Adapter<MohafezViewHolder> implements Filterable {
    ...
    private View view;
    private List<Mohafez> arrayListFiltered;
    private Filter mohafezeenFiltet = new Filter() {
        ...
        protected FilterResults performFiltering(CharSequence constraint) {
            ...
            if (charString.isEmpty()) {
                mohafezeen = arrayListFiltered;
            } else {

                ArrayList<Mohafez> filterList = new ArrayList<>();

                for (Mohafez data : arrayListFiltered) {
        ...
        protected void publishResults(CharSequence constraint, FilterResults results) {
            mohafezeen = (ArrayList<Mohafez>) results.values;
    ...
    public MohafezAdapter(ArrayList<Mohafez> mohafezeen) {
        ...
        this.arrayListFiltered = mohafezeen;
    }
    ...
    public void onBindViewHolder(@NonNull MohafezViewHolder holder, int position) {
        ...
        holder.setItemClickListener((view, position1, isLongClick) -> Toast.makeText(view.getContext(), "" + position, Toast.LENGTH_SHORT).show());
    }
