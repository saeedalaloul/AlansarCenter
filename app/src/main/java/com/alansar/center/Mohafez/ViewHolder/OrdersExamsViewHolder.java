...
public class OrdersExamsViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener, View.OnCreateContextMenuListener {
    public TextView tv_student_name_order_exam, tv_part_order_exam,
            tv_status_order_exam, tv_notes_order_exam, tv_date_order_exam;
    ...
    public void onCreateContextMenu(ContextMenu contextMenu, View view, ContextMenu.ContextMenuInfo contextMenuInfo) {
        ...
        contextMenu.add(0, 0, getAdapterPosition(), Common.DELETE_AN_ORDER);
    }
}
